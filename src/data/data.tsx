...
import profileImage from '../images/portfolio/cuongnguyen.png';
  ...
  description: (
    <>
      ...
      <p className='prose-sm text-stone-200 sm:prose-base lg:prose-lg'>
        ...
        hitting the road on my <strong className='text-stone-100'>motorbike</strong>, and exploring
        the beauty of <strong className='text-stone-100'>Vietnam</strong>.
      </p>
    </>
  ),
  actions: [
...
export const experience: TimelineItemType[] = [
  {
    ...
    content: (
      <div>
        ...
        <p>
          <strong>Technology: </strong>Zustand, Nitro/Native module, AWS-Amplify, Private Gitlab
          package, CI/CD
        </p>
      </div>
    )
  },
  {
    ...
    content: (
      <div>
        <ul>
          <li>
            Joined as an early team member, helping build and launch the Bamboo Careers app from
            scratch.
          </li>
          ...
          <li>
            Implemented core features: Career Paths, Salary Advisor, in-app purchases, and chatbot
            powered by ChatGPT.
          </li>
          <li>Collaborated on UI/UX improvements to boost user engagement.</li>
          <li>
            Reached 2,000+ users with 50+ daily active users (DAU) and initial revenue from 10+
            Premium subscribers.
          </li>
        </ul>
        ...
        <p>
          <strong>Technology:</strong> React Native, Redux, Firebase services, Firestore Database,
          IAP, ChatGPT
        </p>
      </div>
    )
    ...
    content: (
      <div>
        ...
        <ul>
          ...
          <li>
            Reached 30,000+ installs across App Store and Google Play, serving thousands of daily
            active users.
          </li>
        </ul>
        <p>
        ...
        <p>
          <strong>Technology: </strong>React Native/ReactJS/NodeJS, Redux, RESTful API, GA4,
          SmartOcto
        </p>
        <br />
        <p>
        ...
        <p>
          <strong>Features: </strong>Podcast Management, Notification Management, Article
          Management,...
        </p>
        <p>
